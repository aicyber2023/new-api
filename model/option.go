...
func InitOptionMap() {
	...
	common.OptionMap["AlipayPrivateKey"] = operation_setting.AlipayPrivateKey
	common.OptionMap["AlipayPublicKey"] = operation_setting.AlipayPublicKey
	common.OptionMap["AlipaySandbox"] = strconv.FormatBool(operation_setting.AlipaySandbox)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AlipaySandbox":
		operation_setting.AlipaySandbox, _ = strconv.ParseBool(value)
	case "Price":
